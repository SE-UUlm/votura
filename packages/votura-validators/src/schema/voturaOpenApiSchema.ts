...
import { freezablePathObject } from './elections/freezablePathObject.js';
...
import { setInitialPasswordPathObject } from './users/setInitialPasswordPathObject.js';
import { userCountPathObject } from './users/userCountPathObject.js';
import { userDetailsPathObject } from './users/userDetailsPathObject.js';
...
export const voturaOpenApiSchema: OpenAPIV3.Document = {
  ...
  paths: {
    ...
    [`/elections/{${parameter.electionId}}/freezable`]: freezablePathObject,

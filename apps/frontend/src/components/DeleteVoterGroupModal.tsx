...
export const DeleteVoterGroupModal = ({
  ...
  return (
    <Modal opened={opened} onClose={onClose} title={t('deletingVoterGroup', 'Deleting voter group')}>
      <Text>{t('youAreAboutToDeleteTheVoterGroup', 'You are about to delete the voter group:')}</Text>

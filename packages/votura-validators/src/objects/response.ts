...
export const Response400Object = z.object({
  message: z.string().register(voturaMetadataRegistry, {
    description: 'The request was invalid, the server cannot process it.',
    examples: ['The request was invalid, the server cannot process it.'],
  }),
});
...
export const Response401Object = z.object({
  message: z.string().register(voturaMetadataRegistry, {
    description: 'Invalid authentication, please check your credentials.',
    examples: ['Invalid authentication, please check your credentials.'],
  }),
});
...
export const Response403Object = z.object({
  message: z.string().register(voturaMetadataRegistry, {
    description: 'The user is not authorized to do this action, please check your permissions.',
    examples: ['The user is not authorized to do this action, please check your permissions.'],
  }),
});
...
export const Response406Object = z.object({
  message: z.string().register(voturaMetadataRegistry, {
    description: 'The server is not able to generate a response that is acceptable by the client.',
    examples: ['The server is not able to generate a response that is acceptable by the client.'],
  }),
});
...
export const Response415Object = z.object({
  message: z.string().register(voturaMetadataRegistry, {
    description: 'Content-Type is not supported. Please provide only supported content types.',
    examples: ['Content-Type is not supported. Please provide only supported content types.'],
  }),
});
...
export const Response500Object = z.object({
  message: z.string().register(voturaMetadataRegistry, {
    description: 'Internal Server Error. This should not happen, please report the issue.',
    examples: ['Internal Server Error. This should not happen, please report the issue.'],
  }),
});

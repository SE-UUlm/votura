...
export const DeleteBallotPaperSectionModal = ({
  ...
  return (
    <Modal
      opened={opened}
      onClose={onClose}
      title={t('deletingBallotPaperSection', 'Deleting ballot paper section')}
    >
      <Text>
        {t(
          'youAreAboutToDeleteTheBallotPaperSection',
          'You are about to delete the ballot paper section:',
        )}
      </Text>
